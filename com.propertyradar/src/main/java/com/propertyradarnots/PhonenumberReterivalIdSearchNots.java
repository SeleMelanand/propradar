...
public class PhonenumberReterivalIdSearchNots extends LoginpropertyradarNots {
	...
	public void getphonumber() throws InterruptedException, IOException {
		...
		for (int j = 0; j <= sizeofdata - 1; j++) {
			...
			// wait2.until(ExpectedConditions.elementToBeClickable(driver.findElementByXPath("//span[text()='Add
			// Photo']")));
